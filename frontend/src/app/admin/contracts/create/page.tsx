...
const mockTemplates = [
  ...
  {
    templateId: 'modern_wedding_contract',
  ...
  {
    templateId: 'destination_wedding_contract',
  ...
  {
    templateId: 'luxury_wedding_contract',
...
export default function ContractPage() {
  ...
  const { data: dynamicTemplates, isLoading: isTemplatesLoading } = useQuery({
    queryKey: ['contractTemplates'],
    queryFn: getAllContractTemplates,
  });
  const templates = [...mockTemplates, ...(dynamicTemplates || [])];
